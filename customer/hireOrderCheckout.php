...
<div class="woocommerce-cart container-fluid no-left-padding no-right-padding">
    ...
    <div class="container">
        ...
        <div class="row">
            <!-- Cart Table -->
            <form action="confirmHireOrder.php" method="post" id="payment-form">

                <?php 
                    if (count($productID)>0) {
                        for($x=0;$x<count($productID);$x++){
                ?>
                    <input type="hidden" name="productId[]" readonly value="<?=$productID[$x]?>">
                    <input type="hidden" name="quantity[]" readonly value="<?=$quantity[$x]?>">
                    <input type="hidden" name="days[]" readonly value="<?=$days[$x]?>">
                ...
                <input type="text" name="amount" readonly value="<?=$total?>">
